...
export default function ProductEditPage() {
  ...
  const loadProduct = async () => {
    ...
    try {
      ...
      if (apiError) {
        setErrorMessage(`Não foi possível carregar o produto: ${apiError}.`);
      } else {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const apiError = error?.response?.data?.error;
      if (apiError) {
        setErrorMessage(`Não foi possível atualizar o produto: ${apiError}.`);
      } else {
    ...
    <section className="product-create-page">
      <div className="product-create-card">
        <header className="product-create-header">
          <h1 className="product-create-title">Editar produto</h1>
        ...
        {isLoadingProduct ? (
          <div className="modal-state">Carregando dados do produto...</div>
        ) : null}
